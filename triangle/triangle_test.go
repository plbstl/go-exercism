...
var testData = []testCase{
	...
	{NaT, 2, 5, 2},    // another
	{NaT, 7, 3, 2},    // another
	{Deg, 2, 4, 2},    // this is a degenerate triangle, also isoseles
	{Deg, 1, 4, 3},    // this is a degenerate triangle, also scalene
}
...
// If they are equal, then TestKindFromSides will return false positives.
...
func TestKindFromSides(t *testing.T) {
...
func BenchmarkKindFromSides(b *testing.B) {
	for i := 0; i < b.N; i++ {
		for _, test := range testData {
